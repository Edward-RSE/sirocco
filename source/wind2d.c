...
//      shell_make_grid (ndom, w);
//    }
//    else if (zdom[ndom].coord_type == SPHERICAL)
//    {
//      spherical_make_grid (ndom, w);
//    }
...
//      {
//        rtheta_make_hydro_grid (ndom, w);
//      }
//      else
//      {
//        rtheta_make_grid (ndom, w);
//      }
//    }
//    else if (zdom[ndom].coord_type == CYLVAR)
//    {
//      cylvar_make_grid (ndom, w);
//    }
//    else
//    {
...
//  create_wind_and_plasma_cell_maps ();  /* Populate the maps between plasmamain & wmain */
//
...
//
//
///* Calculate the divergence of the wind at the center of each grid cell */
//  for (n = 0; n < NDIM2; ++n)
//  {
//    wind_div_v (wmain[n].ndom, &wmain[n]);
//  }
//
...
//  for (n = 0; n < NDIM2; ++n)
//  {
//    dvds_ave (wmain[n].ndom, &wmain[n]);
//    dvds_max (wmain[n].ndom, &wmain[n]);
//  }
//
//
