...
int update_force_estimators (PlasmaPtr xplasma, PhotPtr p, PhotPtr phot_mid, double ds, double w_ave, int ndom, double z, double frac_ff,
...
void shell_output_wind_update_diagnostics (double xsum, double psum, double fsum, double csum, double icsum, double lsum, double ausum,
...
double scaled_alpha_sp_integral_band_limited (struct topbase_phot *cont_ptr, PlasmaPtr xplasma, int ichoice, double freq_min,
                                              double freq_max);
...
int populate_ion_rate_matrix (double rate_matrix[nions][nions], double pi_rates[nions], double inner_rates[n_inner_tot],
                              double rr_rates[nions], double b_temp[nions], double xne, double nh1, double nh2);
/* para_update.c */
...
int reduce_macro_atom_estimators (void);
...
int macro_pops_fill_rate_matrix (MacroPtr mplasma, PlasmaPtr xplasma, double xne, int index_element, double rate_matrix[200][200],
                                 int radiative_flag[200][200], int conf_to_matrix[200]);
int macro_pops_check_for_population_inversion (int index_element, double *populations, int radiative_flag[200][200],
                                               int conf_to_matrix[200]);
int macro_pops_check_densities_for_numerical_errors (PlasmaPtr xplasma, int index_element, double *populations, int conf_to_matrix[200],
                                                     int n_iterations);
